...
public class Vm implements Serializable {
    ...
    /**
     * 设备点位id，对应mq_point_position表的主键id
     */
    @Column(name = "point_position_id")
    private Long pointPositionId;

    /**
     * 商圈id，对应新的商圈表 mq_business_area 的主键id（冗余）
     */
    @Column(name = "business_area_id")
    private Long businessAreaId;

    /**
     * 二级行业id，对应行业表 mq_industry 的主键id（冗余）
     */
    @Column(name = "industry_id")
    private Long industryId;

    /**
     * 一级行业id，二级行业关联的父id（冗余）
     */
     ...
     *
     * @param macAddress 售货机mac地址或者硬件编码。由出厂时录入
     */
     ...
     * 设置运营状态 0：未运营 1：运营中
     *
     * @param vmStatus 运营状态 0：未运营 1：运营中
     */
     ...
     *
     * @param faultLock 机器故障锁定不能购买，0：未锁定，1锁定
     */
     ...
     *
     * @param vmPropertyInfo 组合机的各个柜子的型号id,  12,34,21
     */
     ...
     *
     * @param modelType 0：非组合机机型 1：组合机（代表主柜 ）
     */
     ...
     *
     * @param groupIndexes 对应的主柜和副柜的索引，按顺序从0开始排列，例如：0,1,2,3  0：代表第一台机器，1：第二台机器
     */
     ...
     *
     * @param taskType  0：正常，1:待补货 ，2：待维修(现在待维修就是未连接，后期会加其他)
     */
     ...
     * 设置是否删除0:正常 1:已经删除
     *
     * @param isDeleted 是否删除0:正常 1:已经删除
     */
     ...
     * 设置是否联网 0：未联网，1：联网
     *
     * @param isOnline 是否联网 0：未联网，1：联网
     */
     ...
     *
     * @param isSupportGroup 是否支持分组 0:不支持 false，1：支持 true；
     */
     ...
     * 设置是否设置了位置，0：否，1：设置了
     *
     * @param isSetPosition 是否设置了位置，0：否，1：设置了
     */
     ...
     *
     * @param isBindVm 是否绑定过机器二维码 0-未绑定 1-已绑定
     */
     ...
     *
     * @param isBindBox 是否绑定过格子二维码 0-未绑定 1-已绑定
     */
     ...
     *
     * @param currentoperatorid 当前的运营商。如果为0，表示未分配。查询未分配柜机的时候，可以通过这个来查询
     */
     ...
     * 设置设置成待维修之前的状态，-1表示没有
     *
     * @param frontQualityStatus 设置成待维修之前的状态，-1表示没有
     */
     ...
     *
     * @return quality_status - 质检端标识机器的状态，0:待激活 1：待检测  2： 检测中   3：待维修  4：已合格，5:已分配，1、2一起归为待质检
     */
     ...
     *
     * @param qualityStatus 质检端标识机器的状态，0:待激活 1：待检测  2： 检测中   3：待维修  4：已合格，5:已分配，1、2一起归为待质检
     */
     ...
     *
     * @param isCorrectbindingmacaddress 绑定主板序列号是否正确 0： 否 1：是
     */
     ...
     * 设置货到检测是否通过 0：否 1：是
     *
     * @param isThroughroadtest 货到检测是否通过 0：否 1：是
     */
     ...
     *
     * @param isThroughotherhardwaretest 其他硬件部分是否通过检测 0：否 1：是
     */
     ...
     * 设置是否通过温度检测 0：否 1：是
     *
     * @param isThroughtemperaturetest 是否通过温度检测 0：否 1：是
     */
     ...
     *
     * @param isOpenAutoTempControl 是否开启自动化温度控制,0:未开启,1;开启
     */
     ...
     *
     * @param testState 质检状态, 0000 -> 4个字节分别表示 货道，温度，网络，设备信息状态
     */
     ...
     * 设置关联的价格模板的id
     *
     * @param priceTemplateId 关联的价格模板的id
     */
     ...
     * 设置价格模板变更时间
     *
     * @param priceTemplateUpdateTime 价格模板变更时间
     */
     ...
     * 设置质检端最近一次激活板子的时间
     *
     * @param activateTime 质检端最近一次激活板子的时间
     */
    ...
    /**
     * 获取设备点位id，对应mq_point_position表的主键id
     *
     * @return point_position_id - 设备点位id，对应mq_point_position表的主键id
     */
    public Long getPointPositionId() {
        return pointPositionId;
    }

    /**
     * 设置设备点位id，对应mq_point_position表的主键id
     *
     * @param pointPositionId 设备点位id，对应mq_point_position表的主键id
     */
    public void setPointPositionId(Long pointPositionId) {
        this.pointPositionId = pointPositionId;
    }

    /**
     * 获取商圈id，对应新的商圈表 mq_business_area 的主键id（冗余）
     *
     * @return business_area_id - 商圈id，对应新的商圈表 mq_business_area 的主键id（冗余）
     */
    ...
    /**
     * 设置商圈id，对应新的商圈表 mq_business_area 的主键id（冗余）
     *
     * @param businessAreaId 商圈id，对应新的商圈表 mq_business_area 的主键id（冗余）
     */
    ...
    /**
     * 获取二级行业id，对应行业表 mq_industry 的主键id（冗余）
     *
     * @return industry_id - 二级行业id，对应行业表 mq_industry 的主键id（冗余）
     */
    ...
    /**
     * 设置二级行业id，对应行业表 mq_industry 的主键id（冗余）
     *
     * @param industryId 二级行业id，对应行业表 mq_industry 的主键id（冗余）
     */
    ...
    /**
     * 获取一级行业id，二级行业关联的父id（冗余）
     *
     * @return first_industry_id - 一级行业id，二级行业关联的父id（冗余）
     */
    ...
    /**
     * 设置一级行业id，二级行业关联的父id（冗余）
     *
     * @param firstIndustryId 一级行业id，二级行业关联的父id（冗余）
     */
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getVmNumber() == null ? other.getVmNumber() == null : this.getVmNumber().equals(other.getVmNumber()))
            && (this.getVmAlias() == null ? other.getVmAlias() == null : this.getVmAlias().equals(other.getVmAlias()))
            ...
            && (this.getVmStatus() == null ? other.getVmStatus() == null : this.getVmStatus().equals(other.getVmStatus()))
            && (this.getFaultLock() == null ? other.getFaultLock() == null : this.getFaultLock().equals(other.getFaultLock()))
            && (this.getVmPropertyInfo() == null ? other.getVmPropertyInfo() == null : this.getVmPropertyInfo().equals(other.getVmPropertyInfo()))
            ...
            && (this.getGroupIndexes() == null ? other.getGroupIndexes() == null : this.getGroupIndexes().equals(other.getGroupIndexes()))
            && (this.getProductRoadType() == null ? other.getProductRoadType() == null : this.getProductRoadType().equals(other.getProductRoadType()))
            ...
            && (this.getLastTaskTime() == null ? other.getLastTaskTime() == null : this.getLastTaskTime().equals(other.getLastTaskTime()))
            ...
            && (this.getStartOperateTime() == null ? other.getStartOperateTime() == null : this.getStartOperateTime().equals(other.getStartOperateTime()))
            && (this.getIsSupportGroup() == null ? other.getIsSupportGroup() == null : this.getIsSupportGroup().equals(other.getIsSupportGroup()))
            && (this.getBatchNumber() == null ? other.getBatchNumber() == null : this.getBatchNumber().equals(other.getBatchNumber()))
            && (this.getMainboardCode() == null ? other.getMainboardCode() == null : this.getMainboardCode().equals(other.getMainboardCode()))
            && (this.getIsSetPosition() == null ? other.getIsSetPosition() == null : this.getIsSetPosition().equals(other.getIsSetPosition()))
            && (this.getQrcode() == null ? other.getQrcode() == null : this.getQrcode().equals(other.getQrcode()))
            && (this.getIsBindVm() == null ? other.getIsBindVm() == null : this.getIsBindVm().equals(other.getIsBindVm()))
            && (this.getIsBindBox() == null ? other.getIsBindBox() == null : this.getIsBindBox().equals(other.getIsBindBox()))
            && (this.getCurrentoperatorid() == null ? other.getCurrentoperatorid() == null : this.getCurrentoperatorid().equals(other.getCurrentoperatorid()))
            && (this.getDescription() == null ? other.getDescription() == null : this.getDescription().equals(other.getDescription()))
            && (this.getFrontQualityStatus() == null ? other.getFrontQualityStatus() == null : this.getFrontQualityStatus().equals(other.getFrontQualityStatus()))
            && (this.getQualityStatus() == null ? other.getQualityStatus() == null : this.getQualityStatus().equals(other.getQualityStatus()))
            && (this.getIsCorrectbindingmacaddress() == null ? other.getIsCorrectbindingmacaddress() == null : this.getIsCorrectbindingmacaddress().equals(other.getIsCorrectbindingmacaddress()))
            && (this.getIsThroughroadtest() == null ? other.getIsThroughroadtest() == null : this.getIsThroughroadtest().equals(other.getIsThroughroadtest()))
            && (this.getIsThroughotherhardwaretest() == null ? other.getIsThroughotherhardwaretest() == null : this.getIsThroughotherhardwaretest().equals(other.getIsThroughotherhardwaretest()))
            && (this.getIsThroughtemperaturetest() == null ? other.getIsThroughtemperaturetest() == null : this.getIsThroughtemperaturetest().equals(other.getIsThroughtemperaturetest()))
            && (this.getCreateTime() == null ? other.getCreateTime() == null : this.getCreateTime().equals(other.getCreateTime()))
            && (this.getBizAreaId() == null ? other.getBizAreaId() == null : this.getBizAreaId().equals(other.getBizAreaId()))
            && (this.getPlotid() == null ? other.getPlotid() == null : this.getPlotid().equals(other.getPlotid()))
            && (this.getIsOpenAutoTempControl() == null ? other.getIsOpenAutoTempControl() == null : this.getIsOpenAutoTempControl().equals(other.getIsOpenAutoTempControl()))
            && (this.getVersionId() == null ? other.getVersionId() == null : this.getVersionId().equals(other.getVersionId()))
            && (this.getLastSupplyTime() == null ? other.getLastSupplyTime() == null : this.getLastSupplyTime().equals(other.getLastSupplyTime()))
            ...
            && (this.getPriceTemplateId() == null ? other.getPriceTemplateId() == null : this.getPriceTemplateId().equals(other.getPriceTemplateId()))
            && (this.getPriceTemplateUpdateTime() == null ? other.getPriceTemplateUpdateTime() == null : this.getPriceTemplateUpdateTime().equals(other.getPriceTemplateUpdateTime()))
            ...
            && (this.getPointPositionId() == null ? other.getPointPositionId() == null : this.getPointPositionId().equals(other.getPointPositionId()))
            ...
            && (this.getFirstIndustryId() == null ? other.getFirstIndustryId() == null : this.getFirstIndustryId().equals(other.getFirstIndustryId()))
            && (this.getAddressTitle() == null ? other.getAddressTitle() == null : this.getAddressTitle().equals(other.getAddressTitle()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getIsCorrectbindingmacaddress() == null) ? 0 : getIsCorrectbindingmacaddress().hashCode());
        result = prime * result + ((getIsThroughroadtest() == null) ? 0 : getIsThroughroadtest().hashCode());
        result = prime * result + ((getIsThroughotherhardwaretest() == null) ? 0 : getIsThroughotherhardwaretest().hashCode());
        result = prime * result + ((getIsThroughtemperaturetest() == null) ? 0 : getIsThroughtemperaturetest().hashCode());
        ...
        result = prime * result + ((getPriceTemplateUpdateTime() == null) ? 0 : getPriceTemplateUpdateTime().hashCode());
        ...
        result = prime * result + ((getPointPositionId() == null) ? 0 : getPointPositionId().hashCode());
        ...
        result = prime * result + ((getFirstIndustryId() == null) ? 0 : getFirstIndustryId().hashCode());
        result = prime * result + ((getAddressTitle() == null) ? 0 : getAddressTitle().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", pointPositionId=").append(pointPositionId);
        sb.append(", businessAreaId=").append(businessAreaId);
        sb.append(", industryId=").append(industryId);
        sb.append(", firstIndustryId=").append(firstIndustryId);
        sb.append(", addressTitle=").append(addressTitle);
